...
//    }
    ...
    public Page selectPageByTypeID(int typeID,int pageNumber)
    {
        ...
        p.SetPageSizeAndTotalCount(9,totalCount);

        List list=null;
        try {
            list=gDao.selectGoodsByTypeID(typeID,pageNumber,9);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public Page getGoodsRecommendPage(int type,int pageNumber) {
        ...
        List list=null;
        try {
            list = gDao.selectGoodsbyRecommend(type, pageNumber, 9);
...
//			totalCount = gDao.getGoodsCount(typeId);
        ...
        List list=null;
        try {
//			list = gDao.selectGoods(keyword, pageNo, 9);
            list = gDao.selectSearchGoods(keyword,pageNumber,9);
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
