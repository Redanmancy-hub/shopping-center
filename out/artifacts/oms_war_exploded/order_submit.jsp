...
<body>
	...
	<div class="cart-items" style="background-color: rgb(245,235,235)">
		<div class="container">
			<h2>确认收货信息</h2>
			<form class="form-horizontal" action="/order_confirm" method="post" id="payform">
				...
				<h3>支付金额: ${order.total }元</h3><br><br>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 " >
					<label>
						<div class="thumbnail">
							...
							<img src="images/wechat.jpg" alt="微信支付" style="background-color: rgb(245,235,235);border: none">
						</div>
					</label>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 " >
					<label>
						<div class="thumbnail">
							...
							<img src="images/alipay.jpg" alt="支付宝支付" style="background-color: rgb(245,235,235);border: none">
						</div>
					</label>
				</div>
<%--				<div class="col-sm-6 col-md-4 col-lg-3 ">
