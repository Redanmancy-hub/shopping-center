...
<!--products-->
<div class="products" style="background-color: rgb(245,235,235);">
    <div class="container">
        <h2><c:choose><c:when test="${t==2}">个人推荐</c:when><c:otherwise>新品推荐</c:otherwise></c:choose></h2>
                ...
                <div class="product-grid">
                    ...
                    <div class="product-info simpleCart_shelfItem">
                        <div class="product-info-cust prt_name">
                            ...
                            <c:if test="${empty user}">
                                <input type="button" class="item_add items" value="加入购物车" onclick="alert('您未登录,请登录后加入购物车')">
                            </c:if>
