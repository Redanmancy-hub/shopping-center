...
<body>
	...
	<!--account-->
	<div class="account" style="background-color: rgb(245,235,235);">
		<div class="container">
			<div class="register">
				<c:if test="${!empty msg }">
				...
				<c:if test="${!empty failMsg }">
					...
					<div class="register-top-grid">
						...
						<div class="register-but text-center">
						   <input type="submit" value="确认修改" style="float: left"> <a style="float: right" href="reset_password.jsp">忘记密码</a>
						</div>	
						<!-- 收货信息 end -->
						</form>
						<hr>
